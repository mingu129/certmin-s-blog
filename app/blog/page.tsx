      ...
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-3xl overflow-hidden border-t-4 border-l-2 border-r-2 border-b-2 border-[#0831D9]">
        ...
        <div className="bg-gradient-to-r from-[#0997FF] to-[#0831D9] px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-sm">블로그 - 상병 윤민규의 블로그</span>
          </div>
            ...
            {posts.length === 0 ? (
              ...
              posts.map((post) => (
                <Link 
                  ...
                  className="block"
                >
                  <div className="bg-[#ECE9D8] border-2 border-[#003399] rounded p-4 shadow-inner hover:bg-[#FFF8DC] transition-colors cursor-pointer">
